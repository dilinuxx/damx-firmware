...
; ===========================
; Test M85 - Power Off After Inactivity
=============================
M80            ; Turn power supply ON
G4 S5          ; Wait for 5 seconds
M85 S60        ; Set to turn off power after 60 seconds of inactivity
G4 S120        ; Wait for 120 seconds (2 minutes) to simulate inactivity

; ===========================
; Emergency Stop Test: M112 and M410
=============================
M80             ; Turn on the power supply (if applicable)
G1 X100 Y100 Z10 F1500 ; Move to a point
G4 S5           ; Wait for 5 seconds
M410            ; Abort planned moves - stop mid-move
...
M105
Sample Expected Output:
ok T:200.00 /200.00 B:60.00 /60.00 T0:200.00 /200.00
*/
...
#ifndef Y_STOP_PIN
#ifndef Y_MIN_PIN
#define Y_MIN_PIN 42 // Y-
#endif
#ifndef Y_MAX_PIN
#define Y_MAX_PIN 43 // Y+
#endif
#endif
#ifndef Z_STOP_PIN
#ifndef Z_MIN_PIN
...
#ifndef TEMP_CHAMBER_PIN // DS18B20 DATA wire
#define TEMP_CHAMBER_PIN 9
#endif

/*
#ifndef PRESSURE_SENSOR_PIN
#define PRESSURE_SENSOR_PIN 56
#endif
*/

#ifndef PRESSURE_SENSOR_PIN // Analog pin connected to XDB305 sensor
#define PRESSURE_SENSOR_PIN AUX4_12
#endif

#ifndef VACUUM_RELAY_PIN
#define VACUUM_RELAY_PIN AUX2_04
#endif

#ifndef EZO_O2_SIGNAL_PIN
#define EZO_O2_SIGNAL_PIN 4
#endif

#ifndef ARGON_INLET_PIN // ARGON Selenoid Value (PIN 92) 
#define ARGON_INLET_PIN AUX1_07
#endif

#ifndef ARGON_OUTLET_PIN // LEV (PIN 93)
#define ARGON_OUTLET_PIN AUX1_05
#endif

#ifndef ARGON_PUMP_PIN
#define ARGON_PUMP_PIN SERVO0_PIN
#endif

#ifndef S1_SIGNAL_PIN
...
// MISO	PB3	50; MOSI	PB2	51; SCK	PB1	52; SS PB0	53
   ...
   #define TEMP_0_MISO_PIN 69
 #endif
//  #ifndef MAX6675_CS_PIN
//    #define MAX6675_CS_PIN 68
//  #endif
 #ifndef TEMP_0_SCK_PIN
   #define TEMP_0_SCK_PIN 67
 #endif
...
//
#ifndef TEMP_0_PIN
#define TEMP_0_PIN 68 // Analog Input
#endif
#ifndef TEMP_1_PIN
...
#define TEMP_0_CS_PIN 68 // Don't use 53 if using Display/SD card (SDSS) or 49 (SD_DETECT_PIN)
#endif
...
//
#define AUX3_02 -1
#define AUX3_03 50 //50
#define AUX3_04 51
#define AUX3_05 52 //52
#define AUX3_06 53
